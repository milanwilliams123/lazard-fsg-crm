...
const ACTIVITIES_SEED = [
  ...
  { id: "a5", date: "2025-01-10", sponsorId: "sp6", contactId: "c14", lazardBankerId: "lb5", type: "Pitch", description: "Healthcare IT roll-up sell-side mandate", notes: "Sarah led credentials. Michael very focused on our healthcare IT transaction comp set and process management. Asked specifically about our experience with strategic buyers in HIT space.", outcome: "Shortlisted — final round", nextAction: "Prepare final pitch with updated HIT transaction comps", portcoId: "pc14", dealId: "d9", status: "Pending" },
...
const PORTCOS_SEED = [
  ...
  { id: "pc3",  sponsorId: "sp1",  name: "Barracuda Networks",   sector: "TMT / Tech",           description: "Cloud-first cybersecurity company focused on email security, network security, and data protection for SMBs and enterprises. Acquired from Thoma Bravo in 2022.",                                                                       status: "Active",          revenue: "$520M",  ebitda: "$95M",  investmentYear: 2022, contactId: "c3",  notes: "Add-on acquisition strategy underway. Daniel Cho flagged 2 targets for Barracuda platform." },
  { id: "pc19", sponsorId: "sp1",  name: "Simon & Schuster",     sector: "Consumer & Retail",    description: "Third-largest US trade book publisher with iconic imprints including Simon & Schuster, Scribner, and Atria. Acquired from Paramount Global in 2023 for $1.62B.",                                                                        status: "Active",          revenue: "$900M",  ebitda: "$130M", investmentYear: 2023, contactId: "c2",  notes: "Ryan Stanton flagged as potential exit situation 2026-2027. Consumer media M&A relevant." },
  { id: "pc20", sponsorId: "sp1",  name: "USI Insurance Services",sector: "Financial Institutions","description": "One of the largest insurance brokerage and risk management firms in the US, serving middle-market and large corporate clients. KKR has owned since 2012 and significantly scaled.",                                                   status: "Active",          revenue: "$1.6B",  ebitda: "$380M", investmentYear: 2012, contactId: "c1",  notes: "Long-held asset. KKR reinvested $1B+ in 2023. Potential IPO or strategic sale in medium term." },
  { id: "pc21", sponsorId: "sp1",  name: "BrightSpring Health",  sector: "Healthcare",           description: "Leading provider of home and community-based health services — pharmacy solutions, rehabilitation, and behavioral health. Serves high-acuity patients across 50 states.",                                                                status: "Active",          revenue: "$8.2B",  ebitda: "$310M", investmentYear: 2019, contactId: "c2",  notes: "IPO'd January 2024 (Nasdaq: BTSG). KKR retains significant stake. Lauren Kim primary." },

  // ── Blackstone (6 portcos) ───────────────────────────────────────────────
  { id: "pc4",  sponsorId: "sp2",  name: "Medline Industries",   sector: "Healthcare",           description: "Largest privately held manufacturer and distributor of medical supplies in the US. Serves hospitals, nursing homes, and home health agencies across all care settings.",                                                                  status: "Active",          revenue: "$21B",   ebitda: "$1.4B", investmentYear: 2021, contactId: "c5",  notes: "One of largest PE deals ever. Andrew Fielding leads for BX. Potential IPO 2025-2026 flagged by Jon Gray." },
  { id: "pc5",  sponsorId: "sp2",  name: "Chamberlain Group",    sector: "Industrials",          description: "Global leader in access control solutions — garage door openers, gates, and smart home access products. B2B and B2C channels. Acquired from Duchossois Group in 2021.",                                                                 status: "Exploring Exit",  revenue: "$2.0B",  ebitda: "$420M", investmentYear: 2021, contactId: "c6",  notes: "Marcus Lin handling. Dual-track process likely in 2025. Strong strategic buyer interest." },
  { id: "pc6",  sponsorId: "sp2",  name: "Tropical Smoothie Cafe",sector: "Consumer & Retail",   description: "Fast-casual franchise with 1,400+ locations across the US. Blackstone acquired in 2023. Strong unit economics and royalty-based franchise model with high franchisee satisfaction.",                                                    status: "Active",          revenue: "$900M",  ebitda: "$70M",  investmentYear: 2023, contactId: "c4",  notes: "Stephanie Ruiz primary. Franchise platform performing well post-acquisition. Potential sell-side process 2026." },
  { id: "pc22", sponsorId: "sp2",  name: "Ancestry",             sector: "Consumer & Retail",    description: "World's largest genealogy platform with 3.6M+ subscribers in 30+ countries. DNA testing and digital family history services. Blackstone acquired from Silver Lake in 2020 for $4.7B.",                                               status: "Active",          revenue: "$1.0B",  ebitda: "$250M", investmentYear: 2020, contactId: "c4",  notes: "Stephanie primary. Consumer digital subscription platform — potential IPO or strategic sale under consideration." },
  { id: "pc23", sponsorId: "sp2",  name: "Copeland",             sector: "Industrials",          description: "Leading provider of HVAC and refrigeration compressors and climate control technologies. Carved out from Emerson Electric in 2023. Serves residential, commercial, and industrial markets globally.",                                   status: "Active",          revenue: "$3.5B",  ebitda: "$620M", investmentYear: 2023, contactId: "c6",  notes: "Marcus Lin coverage. Industrial carve-out with strong standalone potential. Lazard industrials team well positioned." },
  { id: "pc24", sponsorId: "sp2",  name: "Merlin Entertainments", sector: "Consumer & Retail",   description: "World's second-largest visitor attraction operator — Legoland parks, Madame Tussauds, Sea Life centres, and Alton Towers. Blackstone taken private in 2019.",                                                                          status: "Active",          revenue: "$2.1B",  ebitda: "$380M", investmentYear: 2019, contactId: "c4",  notes: "IPO being explored per Jon Gray commentary. Consumer leisure platform — Lazard consumer team relationship relevant." },

  // ── Apollo (6 portcos) ───────────────────────────────────────────────────
  { id: "pc7",  sponsorId: "sp3",  name: "Arconic",              sector: "Industrials",          description: "Manufacturer of aluminum rolled products, extrusions, and forgings for aerospace, automotive, and industrial markets. Apollo acquired in a ~$5B take-private in 2022.",                                                                status: "Active",          revenue: "$5.7B",  ebitda: "$580M", investmentYear: 2022, contactId: "c7",  notes: "Kevin Tran day-to-day. Large complex industrial — potential for carve-out of aerospace segment in 2025-2026." },
  { id: "pc8",  sponsorId: "sp3",  name: "Presidio",             sector: "TMT / Tech",           description: "IT solutions and managed services provider focused on cybersecurity, cloud, and digital transformation for mid-market enterprises. Apollo re-acquired in 2019.",                                                                          status: "Active",          revenue: "$3.8B",  ebitda: "$320M", investmentYear: 2019, contactId: "c8",  notes: "Priya Mehta coverage. Add-on activity ongoing. Possible re-IPO path being evaluated." },
  { id: "pc9",  sponsorId: "sp3",  name: "Maxim Power",          sector: "Energy",               description: "Independent power producer operating natural gas and renewable energy assets across North America. Apollo focused on energy transition platform build.",                                                                                  status: "Exploring Exit",  revenue: "$340M",  ebitda: "$95M",  investmentYear: 2021, contactId: "c9",  notes: "William Torres flagged potential sale process H2 2025. Lazard energy team should be positioned." },
  { id: "pc25", sponsorId: "sp3",  name: "Yahoo",                sector: "TMT / Tech",           description: "Iconic internet media and technology company encompassing Yahoo Mail, Yahoo Finance, Yahoo Sports, and advertising technology. Apollo acquired from Verizon for ~$5B in 2021.",                                                          status: "Active",          revenue: "$1.7B",  ebitda: "$290M", investmentYear: 2021, contactId: "c8",  notes: "Priya Mehta coverage. Digital media platform — exploring strategic options including sale or partial exit." },
  { id: "pc26", sponsorId: "sp3",  name: "ADT",                  sector: "Financial Institutions","description": "Largest residential security company in the US with 6M+ customers. Apollo took private in 2016 for $6.9B and has managed IPO, re-investment, and Google partnership strategy.",                                                     status: "Active",          revenue: "$4.9B",  ebitda: "$1.1B", investmentYear: 2016, contactId: "c7",  notes: "Long-held asset. Kevin Tran primary. Apollo exploring further monetization options on remaining stake." },
  { id: "pc27", sponsorId: "sp3",  name: "Novolex",              sector: "Industrials",          description: "Leading manufacturer of packaging products — bags, wraps, and foodservice packaging for retailers, restaurants, and institutions. Apollo acquired in 2016 and built via acquisitions.",                                                  status: "Active",          revenue: "$3.2B",  ebitda: "$420M", investmentYear: 2016, contactId: "c7",  notes: "Kevin Tran coverage. Packaging consolidation platform. Potential sale or IPO being evaluated for 2025-2026." },

  // ── Carlyle (5 portcos) ──────────────────────────────────────────────────
  { id: "pc10", sponsorId: "sp4",  name: "StandardAero",         sector: "Industrials",          description: "One of the world's largest independent providers of aviation MRO services. IPO'd October 2024 on NYSE (SARO). Carlyle retains significant stake post-offering.",                                                                        status: "Active",          revenue: "$4.7B",  ebitda: "$520M", investmentYear: 2019, contactId: "c10", notes: "IPO'd October 2024. Carlyle retains stake. Jason Merritt primary for secondary advisory." },
  { id: "pc11", sponsorId: "sp4",  name: "MedRisk",              sector: "Healthcare",           description: "Leading managed care solution for workers' compensation physical and occupational therapy. Carlyle acquired in 2017, CVC took majority in 2021 with Carlyle retaining significant minority.",                                             status: "Active",          revenue: "$260M",  ebitda: "$65M",  investmentYear: 2017, contactId: "c11", notes: "Emily Hartman coverage. CVC co-ownership structure. Potential strategic sale 2025-2026." },
  { id: "pc28", sponsorId: "sp4",  name: "CommScope",            sector: "TMT / Tech",           description: "Global provider of network infrastructure solutions including cable systems, connectivity hardware, and wireless infrastructure for service providers and enterprises.",                                                                    status: "Active",          revenue: "$4.2B",  ebitda: "$620M", investmentYear: 2019, contactId: "c10", notes: "Jason Merritt coverage. Complex capital structure. Potential asset sale or recapitalization being evaluated." },
  { id: "pc29", sponsorId: "sp4",  name: "ZoomInfo",             sector: "TMT / Tech",           description: "Leading B2B intelligence and go-to-market platform providing sales, marketing, and recruiting teams with real-time contact and company data. Carlyle backed pre-IPO growth.",                                                             status: "Active",          revenue: "$1.1B",  ebitda: "$390M", investmentYear: 2019, contactId: "c10", notes: "IPO'd June 2020 (Nasdaq: ZI). Carlyle retains position. Watching for secondary or strategic M&A activity." },
  { id: "pc30", sponsorId: "sp4",  name: "Sedgwick",             sector: "Financial Institutions","description": "Leading global provider of technology-enabled risk, benefits, and integrated business solutions — claims management, absence management, and advisory services.",                                                                      status: "Active",          revenue: "$3.4B",  ebitda: "$680M", investmentYear: 2018, contactId: "c11", notes: "Emily Hartman coverage. Long-held asset. Significant scale in claims administration. Exit options being evaluated." },

  // ── TPG (5 portcos) ──────────────────────────────────────────────────────
  { id: "pc12", sponsorId: "sp5",  name: "Convey Health Solutions",sector: "Healthcare",         description: "Technology and services company enabling health plans with member engagement, benefits administration, and government programs.",                                                                                                          status: "Active",          revenue: "$180M",  ebitda: "$40M",  investmentYear: 2021, contactId: "c12", notes: "Brandon Wu managing. Exploring strategic alternatives as market conditions improve." },
  { id: "pc13", sponsorId: "sp5",  name: "McAfee Enterprise",    sector: "TMT / Tech",           description: "Enterprise cybersecurity software business carved out from the McAfee consumer and enterprise split in 2021. Provides endpoint, network, and cloud security solutions.",                                                                   status: "Exploring Exit",  revenue: "$1.4B",  ebitda: "$380M", investmentYear: 2021, contactId: "c13", notes: "Samantha Osei flagged dual-track consideration. Lazard TMT well positioned given prior software work." },
  { id: "pc31", sponsorId: "sp5",  name: "WellSky",              sector: "Healthcare",           description: "Leading health and community care technology company — software for home health, hospice, behavioral health, and blood management. TPG acquired from TPG-owned CareCentrix platform.",                                                    status: "Active",          revenue: "$310M",  ebitda: "$90M",  investmentYear: 2020, contactId: "c12", notes: "Brandon Wu primary. HIT platform with strong NRR. Exploring exit options for 2025-2026." },
  { id: "pc32", sponsorId: "sp5",  name: "DirecTV",              sector: "Consumer & Retail",    description: "Largest US satellite TV provider with ~11M subscribers. TPG acquired 30% from AT&T in 2021, completed full acquisition of remaining 70% in July 2025 following merger talks with Dish.",                                                status: "Active",          revenue: "$14.2B", ebitda: "$2.1B", investmentYear: 2021, contactId: "c13", notes: "Full ownership since July 2025. Massive asset — potential strategic transactions with streamers or telcos on the horizon." },
  { id: "pc33", sponsorId: "sp5",  name: "LifeStance Health",    sector: "Healthcare",           description: "Largest US outpatient behavioral health services provider with 3,500+ clinicians across 350+ clinics. TPG backed in 2020 and took public in 2021 (Nasdaq: LFST).",                                                                      status: "Active",          revenue: "$1.1B",  ebitda: "$85M",  investmentYear: 2020, contactId: "c12", notes: "IPO'd June 2021. TPG remains significant holder. Brandon Wu primary for any secondary or strategic advisory." },

  // ── Warburg Pincus (5 portcos) ───────────────────────────────────────────
  { id: "pc14", sponsorId: "sp6",  name: "Modernizing Medicine",  sector: "Healthcare",          description: "Specialty-specific EHR and practice management platform serving dermatology, ophthalmology, GI, and other specialties. Warburg invested in 2017. $5B+ sale process underway.",                                                          status: "Exploring Exit",  revenue: "$310M",  ebitda: "$55M",  investmentYear: 2017, contactId: "c14", notes: "Michael Bassett primary. Warburg exploring $5B+ sale per Reuters Jan 2025. Active mandate opportunity." },
  { id: "pc34", sponsorId: "sp6",  name: "Duravant",              sector: "Industrials",         description: "Mission-critical packaging and processing equipment manufacturer serving food & beverage, e-commerce, and agriculture. Warburg-backed buy-and-build platform with 16 global locations.",                                                  status: "Active",          revenue: "$1.1B",  ebitda: "$210M", investmentYear: 2017, contactId: "c15", notes: "Aisha Patel coverage. Active add-on strategy. Potential exit via strategic sale 2025-2026." },
  { id: "pc35", sponsorId: "sp6",  name: "Ensemble Health Partners",sector: "Healthcare",        description: "Tech-enabled revenue cycle management company serving large health systems. Warburg-backed from early stage — now one of largest RCM platforms in the US.",                                                                              status: "Active",          revenue: "$680M",  ebitda: "$150M", investmentYear: 2018, contactId: "c14", notes: "Michael Bassett coverage. Strong growth story. IPO or strategic sale likely within 2-3 years." },
  { id: "pc36", sponsorId: "sp6",  name: "Sotera Health",         sector: "Healthcare",          description: "Leading provider of mission-critical sterilization services and lab testing for medical devices, pharma, and food safety. Warburg-backed and IPO'd November 2020 (Nasdaq: SHC).",                                                         status: "Active",          revenue: "$1.1B",  ebitda: "$390M", investmentYear: 2011, contactId: "c15", notes: "Long-held Warburg asset. Aisha Patel coverage. Warburg retains significant stake — watching secondary or M&A activity." },
  { id: "pc37", sponsorId: "sp6",  name: "Pregis",                sector: "Industrials",         description: "Leading manufacturer of protective packaging solutions — air pillows, foam, wraps, and mailers — for e-commerce, healthcare, and industrial markets. Warburg acquired in 2017.",                                                          status: "Active",          revenue: "$950M",  ebitda: "$195M", investmentYear: 2017, contactId: "c15", notes: "Aisha Patel coverage. Packaging platform with strong e-commerce tailwinds. Potential exit 2025." },

  // ── Thoma Bravo (5 portcos) ──────────────────────────────────────────────
  { id: "pc15", sponsorId: "sp7",  name: "Proofpoint",            sector: "TMT / Tech",          description: "Enterprise cybersecurity and compliance company. Market leader in email security, threat intelligence, and information protection. $12.3B take-private in 2021.",                                                                         status: "Active",          revenue: "$1.1B",  ebitda: "$330M", investmentYear: 2021, contactId: "c16", notes: "Chris Haddad coverage. $2B ARR reached 2024. IPO being actively prepared for 2025-2026." },
  { id: "pc16", sponsorId: "sp7",  name: "ConnectWise",           sector: "TMT / Tech",          description: "Business management platform for MSPs — PSA, RMM, and cybersecurity tools. Thoma Bravo acquired in 2019 and scaled via organic growth and add-ons.",                                                                                   status: "Active",          revenue: "$680M",  ebitda: "$175M", investmentYear: 2019, contactId: "c17", notes: "Natalie Brooks managing. Active add-on pipeline. Exit likely 2026 via strategic sale or IPO." },
  { id: "pc38", sponsorId: "sp7",  name: "SailPoint Technologies", sector: "TMT / Tech",         description: "Market leader in enterprise identity security — governing who has access to what across cloud and on-premise systems. Thoma Bravo acquired for $6.9B in 2022 and re-IPO'd in 2024.",                                                      status: "Active",          revenue: "$650M",  ebitda: "$180M", investmentYear: 2022, contactId: "c16", notes: "Chris Haddad coverage. IPO'd NYSE 2024 (SAIL). Thoma Bravo retains stake — secondary activity on radar." },
  { id: "pc39", sponsorId: "sp7",  name: "Sophos",                sector: "TMT / Tech",          description: "Global leader in cybersecurity — endpoint, network, email, and cloud security for mid-market enterprises and MSPs. Thoma Bravo has owned since 2019.",                                                                                   status: "Active",          revenue: "$520M",  ebitda: "$130M", investmentYear: 2019, contactId: "c17", notes: "Natalie Brooks coverage. Add-on acquisitions ongoing. Exit via strategic sale to larger security platform likely." },
  { id: "pc40", sponsorId: "sp7",  name: "Darktrace",             sector: "TMT / Tech",          description: "AI-native cybersecurity company using autonomous response to detect and neutralize threats in real time. Thoma Bravo agreed to take private for $5.3B in April 2024.",                                                                    status: "Active",          revenue: "$620M",  ebitda: "$105M", investmentYear: 2024, contactId: "c16", notes: "Recently privatized. Chris Haddad leading. New Thoma Bravo platform — add-on strategy being developed." },

  // ── Vista Equity (5 portcos) ─────────────────────────────────────────────
  { id: "pc17", sponsorId: "sp8",  name: "Solera Holdings",       sector: "TMT / Tech",          description: "Global data and software company providing risk and asset management solutions for automotive, insurance, and property industries. Vista acquired in 2016 for $6.5B.",                                                                    status: "Active",          revenue: "$2.8B",  ebitda: "$820M", investmentYear: 2016, contactId: "c18", notes: "Tyler Johnson day-to-day. Complex multi-product platform. Long-held asset — exit optionality being evaluated." },
  { id: "pc41", sponsorId: "sp8",  name: "Finastra",              sector: "Financial Institutions","description": "One of the world's largest fintech companies — banking software for lending, treasury, payments, and capital markets. Vista created via merger of D+H and Misys in 2017.",                                                            status: "Active",          revenue: "$1.9B",  ebitda: "$450M", investmentYear: 2017, contactId: "c18", notes: "Tyler Johnson coverage. Complex carve-out/merger history. Strategic sale to financial sector acquirer likely path." },
  { id: "pc42", sponsorId: "sp8",  name: "KnowBe4",               sector: "TMT / Tech",          description: "World's largest security awareness training and simulated phishing platform. Vista taken private in 2023 for $4.6B after KnowBe4 had been public since 2021.",                                                                          status: "Active",          revenue: "$420M",  ebitda: "$115M", investmentYear: 2023, contactId: "c18", notes: "Tyler Johnson primary. Vista's typical buy-and-build in cybersecurity. Add-on acquisitions expected." },
  { id: "pc43", sponsorId: "sp8",  name: "Avalara",               sector: "TMT / Tech",          description: "Leading cloud-based tax compliance automation software serving 30,000+ businesses. Vista acquired for $8.4B in 2022 in one of the largest SaaS take-privates.",                                                                          status: "Active",          revenue: "$850M",  ebitda: "$195M", investmentYear: 2022, contactId: "c18", notes: "Tyler Johnson coverage. Large-scale SaaS — Vista optimizing operations pre-exit. IPO or strategic sale likely 2026." },
  { id: "pc44", sponsorId: "sp8",  name: "Duck Creek Technologies",sector: "TMT / Tech",         description: "Leading provider of SaaS-based policy, billing, and claims software for P&C insurance carriers. Vista acquired via secondary buyout in 2023.",                                                                                           status: "Active",          revenue: "$310M",  ebitda: "$72M",  investmentYear: 2023, contactId: "c18", notes: "Tyler Johnson primary. Insurance software vertically focused — aligned with Vista's B2B SaaS thesis." },

  // ── Bain Capital (5 portcos) ─────────────────────────────────────────────
  { id: "pc18", sponsorId: "sp10", name: "Waystar",               sector: "Healthcare",          description: "Cloud-based revenue cycle management technology serving hospitals and health systems. Bain backed from early stages. IPO'd June 2024 (Nasdaq: WAY), Bain retains ~16.8%.",                                                               status: "Active",          revenue: "$820M",  ebitda: "$290M", investmentYear: 2019, contactId: "c22", notes: "James Okonkwo primary. Bain retains stake post-IPO with EQT and CPPIB. Secondary block trade advisory relevant." },
  { id: "pc45", sponsorId: "sp10", name: "Canada Goose",          sector: "Consumer & Retail",   description: "Leading luxury performance apparel brand known for premium outerwear. Bain Capital took a growth investment in 2013 and supported IPO in 2017 (NYSE/TSX: GOOS), retaining meaningful position.",                                         status: "Active",          revenue: "$1.3B",  ebitda: "$285M", investmentYear: 2013, contactId: "c21", notes: "Elena Vasquez coverage. Luxury consumer brand with global expansion. Bain retains board presence." },
  { id: "pc46", sponsorId: "sp10", name: "Varsity Brands",        sector: "Consumer & Retail",   description: "The largest U.S. provider of cheerleading apparel, uniforms, and camp programs through BSN Sports and Varsity Spirit. Bain-backed with strong youth sports market tailwinds.",                                                           status: "Exploring Exit",  revenue: "$1.5B",  ebitda: "$310M", investmentYear: 2018, contactId: "c21", notes: "Elena Vasquez flagged active exit process. Lazard consumer credentials relevant. Sale or IPO being explored." },
  { id: "pc47", sponsorId: "sp10", name: "Sensata Technologies",  sector: "Industrials",         description: "Global industrial technology company — sensors and controls for automotive, HVAC, aerospace, and industrial OEMs. Bain acquired from Texas Instruments in 2006 for ~$3B, IPO'd 2010.",                                                   status: "Active",          revenue: "$3.5B",  ebitda: "$680M", investmentYear: 2006, contactId: "c22", notes: "James Okonkwo coverage. Public company (NYSE: ST). Bain retains minority stake — watching for further monetization." },
  { id: "pc48", sponsorId: "sp10", name: "Virgin Voyages",        sector: "Consumer & Retail",   description: "Premium adult-only cruise line with 4 ships launched under the Virgin brand. Bain Capital and Virgin Group co-investors. Modern cruise concept targeting millennial luxury travelers.",                                                    status: "Active",          revenue: "$680M",  ebitda: "$95M",  investmentYear: 2015, contactId: "c21", notes: "Elena Vasquez coverage. Consumer leisure platform with growth potential. Exit options being monitored." },
];
...
const DEALS_SEED = [
  ...
  { id: "d7", name: "StandardAero IPO Advisory", portcoId: "pc10", sellerSponsorId: "sp4", sector: "Industrials", lazardRole: "Sell-Side", status: "Closed Won", description: "Carlyle selected Lazard as advisor on StandardAero IPO process. StandardAero IPO'd October 2024 on NYSE (SARO), raising ~$1.4B. Carlyle retained significant stake post-offering.", buySideFirms: [], notes: "Lazard advised on the IPO process alongside Goldman Sachs. Closed October 2024. Strong credential for Lazard aerospace & defense capabilities.", date: "2025-02-22" },
  { id: "d8", name: "Tropical Smoothie Cafe Sell-Side", portcoId: "pc6", sellerSponsorId: "sp2", sector: "Consumer & Retail", lazardRole: "Sell-Side", status: "Pitching", description: "Blackstone exploring sale or recapitalization of Tropical Smoothie Cafe. Fast-casual franchise with 1,400+ locations acquired in 2023. Lazard pitching sell-side advisory against Evercore and GS.", buySideFirms: [], notes: "Stephanie Ruiz primary BX contact. Rachel Torres leading Lazard pitch. Final round presentation week of 3/31. Consumer franchise M&A credentials are the key differentiator.", date: "2025-03-18" },
  { id: "d9", name: "Modernizing Medicine Strategic Sale", portcoId: "pc14", sellerSponsorId: "sp6", sector: "Healthcare", lazardRole: "Sell-Side", status: "Pitching", description: "Warburg Pincus exploring $5B+ sale of Modernizing Medicine, a specialty EHR market leader. WP first invested in 2017. Lazard pitching sell-side advisory on the process.", buySideFirms: [], notes: "Michael Bassett primary WP contact. Sarah Mitchell leading Lazard HC pitch. WP also explored options in 2022 before talks fizzled. Strong strategic buyer universe in healthcare IT.", date: "2025-01-10" },
];
...
export default function App() {
  ...
  const TABS = [["dashboard","Dashboard"],["sponsors","Firms"],["contacts","Contacts"],["map","Coverage Map"],["activity","Activity Log"],["deals","Deals"],["team","LZ Team"],["export","Export"]];
    ...
    <div className="crm">
      ...
      <div className="main">
        ...
        {tab === "deals" && !contactPage && (
          <>
            <div className="pghdr"><div><div className="pgtit">Deal Tracker</div><div className="pgsub">Pitches · Mandates · Closed</div></div><button className="abtn" onClick={() => setAddDealOpen(true)}>+ Add Deal</button></div>
            <div className="tb">
              ...
              {["All","Pitching","Mandated","Closed Won","Lost"].map(s => <button key={s} className={`fb ${typeF===s?"on":""}`} onClick={() => setTypeF(s)} style={{ fontSize: 10 }}>{s}</button>)}
