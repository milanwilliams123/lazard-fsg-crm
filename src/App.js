...
const ACTIVITIES_SEED = [
  ...
  { id: "a6", date: "2025-02-28", sponsorId: "sp3", contactId: "c7", lazardBankerId: "lb1", type: "Conference", description: "SuperReturn International — dinner + panel", notes: "Sat next to Kevin Tran at dinner. Discussed industrial supply chain opportunities in post-tariff environment. Kevin flagged two situations Apollo is looking to exit H2 2025. Will Torresintroduced at cocktail hour — new Apollo energy VP.", outcome: "New intro: William Torres (Apollo Energy VP)", nextAction: "Send follow-up note to William Torres", status: "Complete" },
  { id: "a7", date: "2025-02-20", sponsorId: "sp2", contactId: "c5", lazardBankerId: "lb5", type: "Meeting", description: "Healthcare services platform — strategic options", notes: "Andrew is exploring dual-track for portfolio company (~$800M rev, 14% EBITDA margin). Lazard positioned well as lead advisor if process launches Q2. Needs board approval first — timeline 6–8 weeks.", outcome: "Dual-track process under consideration", nextAction: "Draft preliminary process overview memo", status: "In Progress" },
  { id: "a8", date: "2025-02-10", sponsorId: "sp5", contactId: "c12", lazardBankerId: "lb5", type: "Pitch", description: "Healthcare services buy-side advisory", notes: "Lost to Centerview. Brandon cited existing Centerview relationship and fee structure as deciding factors. Feedback: our process experience was strong but relationship wasn't deep enough at senior level.", outcome: "Not selected — lost to Centerview", nextAction: "Re-engage Brandon on next mandate — target Q3", status: "Lost" },
...
function ContactForm({ initial, sponsors, bankers, onSave, onClose }) {
  const [f, setF] = useState(initial ? { ...initial, recentDeals: initial.recentDeals || [], lazardMappings: initial.lazardMappings || [] } : { name: "", title: "", sponsorId: "", sector: "", email: "", phone: "", linkedin: "", recentDeals: [], lastContacted: "", lazardMappings: [], notes: "" });
