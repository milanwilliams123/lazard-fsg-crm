...
const PORTCOS_SEED = [
  ...
  // Bain Capital
  { id: "pc18", sponsorId: "sp10", name: "Waystar", sector: "Healthcare", description: "Cloud-based revenue cycle management technology serving hospitals, health systems, and physician groups.", status: "Active", revenue: "$820M", ebitda: "$290M", investmentYear: 2019, contactId: "c22", notes: "Waystar IPO'd June 2024 (Nasdaq: WAY). Bain retains ~16.8% stake post-IPO alongside EQT and CPPIB. James Okonkwo primary for any secondary block trade advisory." },
];
