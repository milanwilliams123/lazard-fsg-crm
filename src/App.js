...
const ACTIVITIES_SEED = [
  ...
  { id: "a5", date: "2025-03-05", sponsorId: "sp6", contactId: "c14", lazardBankerId: "lb5", type: "Pitch", description: "Healthcare IT roll-up sell-side mandate", notes: "Sarah led credentials. Michael very focused on our healthcare IT transaction comp set and process management. Asked specifically about our experience with strategic buyers in HIT space.", outcome: "Shortlisted — final round", nextAction: "Prepare final pitch with updated HIT transaction comps", status: "Pending" },
  ...
  { id: "a42", date: "2025-02-17", sponsorId: "sp2", contactId: "c5", lazardBankerId: "lb24", type: "Pitch", description: "Blackstone — Medline sell-side advisory pitch", notes: "Teddy and Courtney Haydon pitched BX HC team. Strong credentials presentation covering Lazard's HC distribution and services track record. Competing with JPM.", outcome: "Advanced to final round", nextAction: "Final presentation on 3/15", status: "Pending" },

  // ── Daniel Gajewski (lb25) — Apollo, Carlyle, H&F, Bain, Francisco, Leonard Green ──
  { id: "a43", date: "2025-03-23", sponsorId: "sp3", contactId: "c7", lazardBankerId: "lb25", type: "Meeting", description: "Apollo — Presidio strategic review", notes: "Daniel Gajewski and Priya Mehta discussed Presidio's add-on pipeline and potential re-IPO path. Apollo evaluating options for 2025-2026. Lazard positioned for advisory role.", outcome: "Lazard being considered for Presidio process", nextAction: "Prepare Presidio strategic options memo", status: "In Progress" },
  { id: "a44", date: "2025-03-19", sponsorId: "sp4", contactId: "c11", lazardBankerId: "lb25", type: "Call", description: "Carlyle — MedRisk sale process scoping call", notes: "Daniel and Emily Hartman discussed potential MedRisk sale. Carlyle evaluating strategic buyers in managed care space. Lazard HC team well positioned.", outcome: "Lazard shortlisted for MedRisk mandate", nextAction: "Prepare managed care buyer universe", status: "In Progress" },
  { id: "a45", date: "2025-03-12", sponsorId: "sp9", contactId: "c19", lazardBankerId: "lb25", type: "Meeting", description: "H&F — Sophie Nakamura FIG coverage meeting", notes: "Daniel met Sophie Nakamura to discuss H&F's FIG portfolio. Covered Lazard's FIG M&A credentials and recent specialty finance transactions. H&F very selective on advisors.", outcome: "Building H&F FIG relationship", nextAction: "Send FIG M&A credentials deck", status: "Complete" },
  { id: "a46", date: "2025-03-05", sponsorId: "sp11", contactId: "c23", lazardBankerId: "lb25", type: "Meeting", description: "Francisco Partners — cybersecurity platform review", notes: "Daniel and Amy Chen reviewed FP's cybersecurity add-on pipeline. Barracuda add-on and Forcepoint expansion both active. Lazard pitching for buy-side advisory on one.", outcome: "Lazard engaged on buy-side for FP cybersecurity add-on", nextAction: "Prepare target analysis for FP platform", status: "Pending" },
  { id: "a47", date: "2025-02-20", sponsorId: "sp12", contactId: "c24", lazardBankerId: "lb25", type: "Meeting", description: "Leonard Green — SRS Distribution exit planning", notes: "Daniel met Marcus Webb at LGP's office. SRS Distribution being evaluated for sale — LGP held since 2018. Lazard specialty distribution credentials highly relevant.", outcome: "Lazard top of mind for SRS mandate", nextAction: "Prepare SRS Distribution situation analysis", status: "In Progress" },
  { id: "a48", date: "2025-02-10", sponsorId: "sp10", contactId: "c21", lazardBankerId: "lb25", type: "Conference", description: "ICR Conference — Bain consumer panel", notes: "Daniel attended ICR alongside Elena Vasquez. Discussed Bain's consumer portfolio and upcoming exit decisions. Good informal touchpoint — Elena flagged Varsity Brands as active situation.", outcome: "Lazard flagged for Varsity Brands", nextAction: "Follow up with Bain consumer credentials", status: "Complete" },
];
...
const PORTCOS_SEED = [
  ...
  { id: "pc6", sponsorId: "sp2", name: "Bumble Bee Foods", sector: "Consumer & Retail", description: "Leading branded canned seafood company with tuna, salmon, and sardine product lines. Acquired out of bankruptcy.", status: "Active", revenue: "$900M", ebitda: "$70M", investmentYear: 2020, contactId: "c4", notes: "Stephanie's primary portco. Margin recovery story — watching closely for sell-side timing." },
  // Apollo
...
function ContactForm({ initial, sponsors, bankers, onSave, onClose }) {
  const [f, setF] = useState(initial ? { ...initial, recentDeals: initial.recentDeals || [], lazardMappings: initial.lazardMappings || [] } : { name: "", title: "", sponsorId: "", sector: "", email: "", phone: "", linkedin: "", recentDeals: [], lastContacted: "", lazardMappings: ["lb20", "lb24", "lb21", "lb22", "lb25", "lb23"], notes: "" });
